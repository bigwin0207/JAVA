...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 상황에 따라 기본타입의 데이터를 인스턴스화 해야 경우가 발생한다.
        * 이때 기본타입의 데이터를 먼저 인스턴스로 변환후 사용해야 하는데
        ...
        * 이런 자동화된 박싱과 오톤박싱,오토언박싱이라고 한다.
        * */

        Integer boxingNum3 =intValue;       //오토박싱
        int unBoxingNum3 = boxingNum3;      //오토언
        ...
        System.out.println("int와 Integer" + (inum == integerNum3)); //true
