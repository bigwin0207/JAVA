...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        * singleton-patten이란
        * 에플리케이션이 시작될 때 어떤 클래스가 최초 한 번만 메모리를 할당하고 그 메모리에 인스턴스를 만들어서
        * 하나의 인스턴스를 공유해서 사용하며 메모리 낭비를 방지할 수 있게 함(매번 인스턴스 생성 하지 않음)
        * 장점
        * 1. 첫 번째 이용 시에는 인스턴스를 생성해야하므로 속도차이가 나지 않지만
        *    두 번째 이용 시에는 생성 시간 없이 사용할 수 있다.
        ...
        * */
        ...
        System.out.println("lazy1.hachcone : " + lazy1.hashCode());
        System.out.println("lazy2.hachcone : " + lazy2.hashCode());

        /*
        * 이른 초기화를 사용하면 클래스를 로드하는 속도가 느려지지만
        * 처음 인스턴스 반환 요청에서 속도가 빠르다는 장점을 가진다.
        * 반면 게이른 초기화는 클래스 로드하는 속도는 빠르지만
