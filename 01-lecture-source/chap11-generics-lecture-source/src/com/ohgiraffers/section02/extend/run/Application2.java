...
public class Application2 {
    public static void main(String[] args) {
      ...
      //wildCardFarm.anyType(new RabbitFarm<Mammal>(new Rabbit()));
        ...
        System.out.println("--------------------------------------------------");
      //wildCardFarm.extendsType(new RabbitFarm<Rabbit>(new Rabbit())); // 상위타입으로 만든 것은 매개변수로 사용불가능하다.
      ...
      //wildCardFarm.superType(new RabbitFarm<DrunkenBunny>(new DrunkenBunny())); // 하위타입으로 만든 것은 매개변수로 사용불가능하다.
