...
public class Application {
    public static void main(String[] args) {
        ...
        * 객체 배열에 대해 이해할 수 있다.
        *
        * 객체배열은 레퍼펀스 변수에 대한 배열이다.
        * 생성한 인스턴스도 배열을 이용해서 관리하면
        * 동일한 타입 여러 개 인스턴스를 각각 취급하지 않고 연속 처리할 수 있어서 유용한다.
        ...
        * */
        ...
        car1.deliverMaxSpeed();
        car2.deliverMaxSpeed();
        car3.deliverMaxSpeed();
        car4.deliverMaxSpeed();
        car5.deliverMaxSpeed();
