...
public interface InterProduct extends java.io.Serializable/*, java.util.Comparator */ /* 인터페이스는 다중상속가능 */{
    /*
    * 인터페이스가 인터페이스를 상속받을 시 에는 extends 키워드를 사용하며
    ...
    * */
    ...
    int MIN_NUM = 10; // public static final 생략 가능

    /* 인터페이스는 생성자를 가질 수 없다. */
    // public interProduct(){} // 에러발생

    /* 인터페이스는 구현부가 있는 non-static 메소드를 가질 수 없다. */

    // public void nonStaticMethod(){}; //Interface abstract methods cannot have body(추상메소드가 아니면 만들 수 없다)
    // 추상메소드만 작성가능하다.
    ...
    * */
    ...
    void absMethod(); // 에러 안남 // public abstract 생략 가능
