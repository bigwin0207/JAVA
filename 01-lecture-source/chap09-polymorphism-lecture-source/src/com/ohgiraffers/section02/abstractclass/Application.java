...
public class Application {
    ...
    *  자바에서는 extends 클래스를 상속 받을 시 하나의 부모 클래스만 가질 수 있다.
    * */
    ...
    * */
    ...
    // Product product = new Product(); // 추상클래스는 (인스턴스)객체 생성 불가
    ...
    SmartPhone smartPhone = new SmartPhone();
        ...
        * */
        ...
        /*
        * 하지만 다른 클래스를 상속 받고 있는 클래스를 작성할 시 에는 추상클래스를 추가로 상속받을 수 없다.
