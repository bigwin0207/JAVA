...
public class Application4 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("안녕하세요 저는 \'홍길동 입니다. ");
        //System.out.println(''''); //홀따옴표 문자와 리터럴 기호가 중복되기 때문에 에러남
        System.out.println('\'');

        //System.out.println("안녕하세요\" 저는 "홍길동" 입니다. "); // 문자열 리터럴가 중복되어 에러남
        System.out.println("안녕하세요 저는 \"홍길동\" 입니다. ");


        // System.out.println("안녕하세요 \저는 \홍길동 입니다. "); //역슬래시를 표현하고 싶지만 이스케이프 문자와 겹침
        System.out.println("안녕하세요 \\저는 \\홍길동 입니다. ");
