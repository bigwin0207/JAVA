...
public class Application1 {
    public static void main(String[] args) {
        ...
        *    이런 동일한 메세지를 수신받아 처리하는 내용을 객체별로 다를게 할 수 있다는 장점을 가지고 있다.
        ...
        * */
        ...
        // Rabbit r = new Animal();  // 에러발생
        // Tiger t = new Animal();   // 에러발생
        ...
        * */
        ...
        // a1.jump();  // 레퍼런스 타입이 Animal 이기때문에 Rabbit과 Tiger의 동작을 실행시키지 못한다.
        // a2.bite();
        ...
        // ((Tiger)a1).bite(); // ClassCastException 에러  // 토끼는 호랑이가 될 수 없다.
        ...
        System.out.println("a1이 Object 타입인지 확인 : " + (a1 instanceof Object));   //true //모든 레퍼런스는 Object의 후손이다.
        ...
        * 또한 작성 여부에 따라 명시적과 묵시적으로 두 가지로 구분한다.
        * */
        ...
        // Rabbit rabbit2 = animal2; // down-casting 은 묵시적 형변환이 불가능하다.
